...
```yaml
task_id: technical-backend-engineers-feature-explainer
task: explain the API feature for backend engineers
domain: technical
pack_exists: true
entity_type: feature
entity_name: backend engineers
topic: 'feature_explainer: explain the API feature for backend engineers'
output_type: feature_explainer
artifact_type: feature_explainer
channel: document
intent: inform
...
execution_lane: full
packet_id: technical-feature-backend-engineers
inference:
  mode: inferred
  confidence: medium
  fields_inferred:
...
- knowledge/technical/technical-feature-backend-engineers.yaml
...
diff_qa_mode: packet
diff_qa_baseline_path: outputs/qa/technical-backend-engineers-feature-explainer-baseline.yaml
diff_qa_path: outputs/qa/technical-backend-engineers-feature-explainer-diff.yaml
