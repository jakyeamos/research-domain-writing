...
```yaml
task_id: music-requested-subject-album-review-blurb
task: short album blurb about production
domain: music
pack_exists: true
entity_type: album
...
execution_lane: full
packet_id: music-album-requested-subject
inference:
  mode: inferred
  confidence: medium
  fields_inferred:
...
- knowledge/music/music-album-requested-subject.yaml
...
diff_qa_mode: packet
diff_qa_baseline_path: outputs/qa/music-requested-subject-album-review-blurb-baseline.yaml
diff_qa_path: outputs/qa/music-requested-subject-album-review-blurb-diff.yaml
