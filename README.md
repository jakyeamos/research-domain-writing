...
This source checkout targets `v0.3.0`. PyPI currently publishes `v0.1.0`; the
`v0.3.0` command surface documented below is available from this checkout and
is not a claim that `v0.3.0` is already published. See the [PyPI project
...
The `v0.3.0` baseline does not expose a general `rdw --json` output mode. For
