...
```yaml
task_id: technical-idempotency-keys-feature-explainer
task: explain idempotency keys
domain: technical
pack_exists: true
entity_type: feature
...
execution_lane: full
packet_id: technical-feature-idempotency-keys
inference:
  mode: inferred
  confidence: medium
  fields_inferred:
...
- knowledge/technical/technical-feature-idempotency-keys.yaml
...
diff_qa_mode: packet
diff_qa_baseline_path: outputs/qa/technical-idempotency-keys-feature-explainer-baseline.yaml
diff_qa_path: outputs/qa/technical-idempotency-keys-feature-explainer-diff.yaml
