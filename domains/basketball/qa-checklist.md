# Basketball Domain QA Checklist

## Grounding

- [ ] All stats include season/sample scope (regular season, playoffs, on/off n)
...
- [ ] Metric defined in domain terms (what it captures / misses)
- [ ] Why stat likes or skeptical player ties to mechanism, not label
- [ ] Small-sample and injury caveats present when applicable
